/// @description roomdog_paste_room(room_or_filename, X, Y, FLIP_X_optional, FLIP_Y_optional)
/// @param room_or_filename
/// @param  X
/// @param  Y
/// @param  FLIP_X_optional
/// @param  FLIP_Y_optional
function roomdog_paste_room() {
